...
*/
SELECT d.*,t.人数 FROM t_dept d,
(SELECT deptno,COUNT(deptno)人数 FROM t_employees GROUP BY deptno) t
...
SELECT job,COUNT(*) 人数 FROM emp  GROUP BY job HAVING MIN(sal) > 15000;
...
条件：sal>(查询出公司的平均工资)
*/
SELECT e.*,d.DNAME,t.ename,s.GRADE
FROM emp e,dept d,emp t,salgrade s
